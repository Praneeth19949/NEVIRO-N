  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        Text(
          isSriLanka ? 'Latest official national fuel prices' : 'Find the best fuel prices near you',
    ...
    return Column(
      ...
      children: <Widget>[
              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(detectedArea.isEmpty ? 'Auto-detect or enter a suburb' : 'Auto-detected area', style: const TextStyle(color: kNeviroMuted, fontSize: 12)),
                  ],
                ),
              ),
              TextButton.icon(onPressed: loading ? null : () => _useMyLocation(), icon: const Icon(Icons.my_location_rounded), label: const Text('Locate')),
            ],
          ),
        ),
        ...
        if (waPrices.isNotEmpty) ...<Widget>[
          ...
          Row(
            children: <Widget>[
              const Expanded(child: Text('Nearby Stations', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900))),
          ...
          const _InfoBox(
            ...
            text: 'Western Australia prices are sourced from the official FuelWatch RSS feed. FuelWatch is acknowledged as the data source.',
          ),
        ],
      ],
    );
                          ...
                          child: Column(
                            children: <Widget>[
                              Container(
                                ...
                                decoration: BoxDecoration(color: kNeviroDark, borderRadius: BorderRadius.circular(10), border: Border.all(color: kNeviroGreen)),
                                child: Text(station.priceCentsPerLitre.toStringAsFixed(1), style: const TextStyle(color: kNeviroGreen, fontWeight: FontWeight.w900, fontSize: 11)),
                              ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(15),
          border: Border.all(color: active ? kNeviroGreen : const Color(0xFF245749)),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            Icon(icon, color: active ? kNeviroDark : kNeviroMuted),
            const SizedBox(width: 8),
            Text(label, style: TextStyle(color: active ? kNeviroDark : Colors.white, fontWeight: FontWeight.w800)),
          ],
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: cheapest ? kNeviroGreen : const Color(0xFF17463B), width: cheapest ? 1.4 : 1),
      ),
      child: Column(
        children: <Widget>[
          Row(
            children: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        if (cheapest) ...<Widget>[
                          ...
                          Container(
                            ...
                            child: const Text('Cheapest', style: TextStyle(color: kNeviroDark, fontSize: 10, fontWeight: FontWeight.w900)),
                          ),
                        ],
                      ],
                    ),
              ...
              Column(
                ...
                children: <Widget>[
                  Text('${station.priceCentsPerLitre.toStringAsFixed(1)} c/L', style: TextStyle(color: cheapest ? kNeviroGreen : Colors.white, fontWeight: FontWeight.w900, fontSize: 18)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFF1D594A)),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          ...
          const SizedBox(width: 10),
          Expanded(child: Text(text, style: const TextStyle(color: Color(0xFFC1D7D0), fontSize: 12.5, height: 1.4))),
        ],
      ),
    );
  }
